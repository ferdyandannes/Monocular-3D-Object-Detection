...
def compute_3Dbox(P2, line):
    ...
    print("")
    print("corners_2D[2] = ", corners_2D[2])
...
def draw_3Dbox(ax, P2, line, color):
    ...
    #print("width = ", width)
    #print("height = ", height)
    #print("corners_2D[:, 1] = ", corners_2D[:, 1])
    ax.add_patch(p)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--path', type=str, default='/media/ferdyan/NewDisk/3d_bbox_depth/Hasil', help='Output Image folder')
