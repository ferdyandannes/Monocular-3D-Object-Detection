...
class KITTILoader():
    def __init__(self, subset='training'):
        ...
        depth_dir = os.path.join(self.base_dir, subset, 'depth')
        ...
        for i, fn in enumerate(os.listdir(label_dir)):
            ...
            depth_full_path = os.path.join(depth_dir, fn.replace('.txt', '.png'))

            self.images.append(image_full_path)
            self.depths.append(depth_full_path)

            print("depths = ", depth_full_path)
                ...
                for line, row in enumerate(reader):
                    ...
                    if row['type'] in self.KITTI_cat:
                        if subset == 'training':
                            ...
                            annotation = {'name': row['type'], 'image': image_full_path, 'depth': depth_full_path,
